...
function ddxpyt1(timeout = 0) {
    return new Promise((resolve) => {
        ...
        let url = {
            url: `https://farm.api.ddxq.mobi/api/v2/task/achieve?api_version=9.1.0&app_client_id=1&station_id=${station_id}&native_version=&app_version=9.35.1&uid=${uid}&latitude=${latitude}&longitude=${longitude}&gameId=1&taskCode=LOTTERY`,
            headers: header,
        }
...
function ddxpyt2(timeout = 0) {
    return new Promise((resolve) => {
        ...
        let url = {
            url: `https://farm.api.ddxq.mobi/api/v2/task/achieve?api_version=9.1.0&app_client_id=1&station_id=${station_id}&native_version=&uid=${uid}&latitude=${latitude}&longitude=${longitude}&taskCode=LOTTERY`,
            headers: header,
        }
